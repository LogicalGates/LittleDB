package com.razasaeed.littledb;
...
public class LittleDB {
    ...
    public static void putList(String key, List list) {
        ...
        LittleDB.remove(String.format(Locale.ENGLISH, "listKey_%s_%d", key, list.size()));
    }
    ...
    public static void removeList(String key) {
        LittleDB.remove(String.format(Locale.ENGLISH, "listKey_%s_%d", key, 0));
    }
